...
var levels = [
	...
	{"name": "AARON TIDE",         "portrait": preload("res://others/Takeda_Head.png"),    "color": Color(0.688, 0.655, 0.644, 1.0),"bg": preload("res://BG/Ring 2.png"), "scene": "res://Scene/Levels/level_3.tscn"},
	{"name": "J",                  "portrait": preload("res://others/Santorino_Head.png"), "color": Color(1.0, 0.288, 0.225, 1.0),  "bg": preload("res://BG/Ring 3.png"), "scene": "res://Scene/Levels/level_4.tscn"},
]
